...
export default function AnalyzeContractClientComponent({ params }: { params: { id: string } }) {
  ...
  const contract = {
    id: params.id,
    title: "Service Agreement - Acme Inc", // You might want to fetch this or pass as a prop if it varies
    type: "Service Agreement", // You might want to fetch this or pass as a prop if it varies
    created: "May 10, 2025", // You might want to fetch this or pass as a prop if it varies
    pages: 12, // You might want to fetch this or pass as a prop if it varies
  }
