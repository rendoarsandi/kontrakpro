...
export default [
  ...
  layout("routes/_dashboard/layout.tsx", [
    ...
    route("repository", "routes/_dashboard/repository.tsx"),
    route("workflows", "routes/_dashboard/workflows.tsx"),
    route("editor", "routes/_dashboard/editor.tsx"),
    route("ai", "routes/_dashboard/ai.tsx"),
    route("clickwrap", "routes/_dashboard/clickwrap.tsx"),
    route("reports", "routes/_dashboard/reports.tsx"),
